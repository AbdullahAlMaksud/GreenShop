...
const Navigation = () => {
    return (
        <div className='bg-white/10 dark:bg-black/10 h-14 flex items-center justify-between backdrop-blur-sm'>
            ...
            <a className='flex items-center'>
               ...
               <div className='flex gap-2 items-center'>
                   <Button className='bg-white/50 dark:bg-black rounded-full px-.5 h-fit py-.5'><DarkMode/></Button>
